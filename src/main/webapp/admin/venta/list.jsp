...
<h1 class="text-black text-4xl font-bold">Ventas</h1>
<div class="my-4"> 
...
<a href="/admin?pagina=venta&accion=vender" onclick="showModalCreate()" class="mt-4 hover:bg-primario-400 text-white cursor-pointer transition-all duration-500 bg-primario-800 
