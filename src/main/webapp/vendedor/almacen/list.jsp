...
<h1 class="text-black text-4xl font-bold">Almacen</h1>
<div class="my-4"> 
    <table id="tablaTransporte" class="min-w-[70rem] border-0 w-full ml-0 bg-secondary-800 ">
        ...
        <tbody class="min-w-full border-y-0">
            ...
            <tr class="bg-neutral-3000  text-center py-2  border-stone-500 border-y">
                <td class="hidden"><%=st.getId()%></td>
                <td><%= st.getProducto().getNombre()%></td>
                <td class="border-x border-stone-500"><%= st.getProducto().getEstado().getNombre()%></td>
                <td><%= st.getCantidad()%>  </td>
                <td class="border-x border-stone-500"><%= st.getUbicacion()%></td>
                <td class="text-xl flex justify-center items-center gap-2 "             
                    data-id="<%= st.getId()%>"
                    data-producto ="<%= st.getProducto().getId()%>"
                    data-estado="<%= st.getProducto().getEstado().getId()%>"
                    data-get ="<%= st.getCantidad()%>"
                    data-ubicacion="<%= st.getUbicacion()%>">
